...
public class Constants {
    ...
    public static final int[] MATERIAL_COLORS_02 = {
            rgb("#21ac90"), rgb("#f1c40f")

    };
    public static final int[] MATERIAL_COLORS_03 = {
            rgb("#21ac90"), rgb("#f1c40f"), rgb("#e74c3c")

    };
    public static final int[] MATERIAL_COLORS_04 = {
            rgb("#21ac90"), rgb("#f1c40f"), rgb("#e74c3c"), rgb("#3498db")


    };
    public static final int[] MATERIAL_COLORS_05 = {
            rgb("#21ac90"), rgb("#f1c40f"), rgb("#e74c3c"), rgb("#3498db"), rgb("#f23030")

    };
    public static final int[] MATERIAL_COLORS_06 = {
            rgb("#21ac90"), rgb("#f1c40f"), rgb("#e74c3c"), rgb("#3498db"), rgb("#f23030"), rgb("#1765bd"),
