        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCurrentPosition == pos) {
                    ...
                    Log.e("Bean==mPosition===", "" + mCurrentPosition); //释放的位置
                    mListener.onTabUnselected(mCurrentPosition);
                    mTabLayout.getChildAt(mCurrentPosition).setSelected(false);
                    Log.e("Bean===pos==", "" + pos);  //当前的位置
//                    Log.e("Bean===pos=....=", "" + mTabLayout.getChildCount());  //当前的位置
//                    mListener.onChange(mTabLayout,mCurrentPosition,pos);
...
//        void onChange(LinearLayout mTabLayout, int prePosition, int currentPosition);
